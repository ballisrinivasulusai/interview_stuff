# -*- coding: utf-8 -*-
# (C) Advanced Instrumentation Systems, LLC
# (c) Copyright 2019 Sensirion AG, Switzerland
# Modified by Serge Lafontaine to access through a Tinkerforge RS484 interface
# Change in code is marked with comments below.
...
from rs485.tkserial import tk_serial
import serial
import socket
import time
...
class ShdlcSerialPort(ShdlcPort):
    ...
    def __init__(self, port, baudrate, additional_response_time=0.1,
        ...
        self._lock = RLock()
        '''
        self._serial = serial.tk_serial(port=None, baudrate=baudrate,
                                     bytesize=serial.EIGHTBITS,
                                     parity=serial.PARITY_NONE,
                                     stopbits=serial.STOPBITS_ONE,
                                     timeout=0.01, xonxoff=False)
        '''
        self._serial = tk_serial(port, baudrate=115200) # (C) AIS
